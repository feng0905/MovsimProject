...
public class SubStateFilter extends AbstractParticleSystem {
	...
	{
		this( new PriorSampling(), new LikelihoodWeight(), new SubStateSystematicResampling(), new GenerateSubStates(),new DataAssociation());
	}
